...
// ДЗ к уроку 5.
//1.5
        WebElement webElement19 = driver.findElement(By.xpath(".//*[@id=\"header\"]/div[1]/div/nav/a[1]"));
        webElement19.click();
//2.5
        Actions act = new Actions(driver);
        WebElement onElement = webElement19;
        act.contextClick(onElement).perform();
        act.sendKeys("w").perform();
        driver.findElement(By.xpath("./html/body/header/div/div/div[2]/nav/div/ul/li[1]/a")).click();
